...
# Update the GPT-4All model initialization to use Mistral 7B GGUF model
try:
    ...
    if not os.path.exists(model_path):
        ...
        if os.path.exists(alt_model_path):
            ...
            raise FileNotFoundError(f"Model file not found at {model_path} or {alt_model_path}. Please download the Mistral 7B GGUF model and place it in the resources folder.")
