...
try:
    ...
    if not os.path.exists(model_path):
        print("Files in resources:", os.listdir(os.path.join(os.getcwd(), "resources")))        print("Files in resources:", os.listdir(os.path.join(os.getcwd(), "resources")))        print("Files in resources:", os.listdir(os.path.join(os.getcwd(), "resources")))        # Try fallback: check for .bin extension (some downloads add .bin)
