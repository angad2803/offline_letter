...
def main():
    ...
    def generate_response():
        ...
        # If only one file in dataset, always use uploaded file + instructions mode
        ...
        if use_uploaded or single_file_mode:
            ...
            instructions = user_input if use_uploaded else "Summarize or process the above DO letter as per instructions."
            ...
            # Truncate base_text if prompt would be too long
            max_prompt_length = 2048  # adjust as needed for your model
            prompt_template = (
                "You are an expert in military administration. "
                "Below is a DO letter. "
            ...
            # Estimate available space for base_text
