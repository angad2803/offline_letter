...
def main():
    ...
    def generate_response():
        ...
        base_response = dataset['Response'].iloc[closest_idx]
        prompt = f"You are a professional letter writer. Based on the following base response, generate a detailed and professional draft letter:\n\nBase Response: {base_response}\n\nDraft Letter:"
        detailed_response = gpt_model.generate(prompt, max_tokens=300)
