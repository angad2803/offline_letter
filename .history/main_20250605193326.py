...
def main():
    ...
    def generate_response():
        ...
        if use_uploaded:
            ...
            prompt = (
                "Please review and professionally enhance the following self-appraisal or letter. "
                "Correct grammar, improve clarity, and highlight achievements. "
                "Keep the structure and main points, but make it more impactful and polished.\n\n"
                f"{base_text}"
            )
        else:
