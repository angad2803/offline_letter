...
def main():
    ...
    def generate_response():
        ...
        # If a file was uploaded, treat the textbox as instructions (or additional prompt)
        if use_uploaded:
            ...
            # Compose a prompt that includes both the uploaded letter and user instructions
            prompt = (
