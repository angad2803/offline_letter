...
# Update the GPT-4All model initialization to use a local model file
try:
    model_path = os.path.join(os.getcwd(), "gpt4all-lora-quantized.bin")  # Ensure the model file is in the current working directory
    if not os.path.exists(model_path):
        raise FileNotFoundError(f"Model file not found at {model_path}. Please download it and place it in the application directory.")
